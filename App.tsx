...
import { setupDeepLinkHandler, addPushNotificationListeners, initCapacitor, isIOSPlatform } from "@/services/capacitor";
...
const AppContent = () => {
  ...
  //
  // iOS shows its own native system alert for both notifications and
  // location. Our custom modal was appearing IN FRONT of that native
  // alert, effectively stacking two pop-ups for the same action. On iOS
  // we skip the custom UI entirely and go straight to the OS prompts;
  // Android/web keep the custom onboarding modal as before.
  useEffect(() => {
